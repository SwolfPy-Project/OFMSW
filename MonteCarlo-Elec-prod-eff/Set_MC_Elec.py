...
def Set_MC(Treatment_processes, Collection_processes, common_data):
    ...
    if 'WTE' in Treatment_processes:
        ...
        # Combustion efficiency for electricity production 
        WTE_Input.Elec_Prod_Eff['Gross_Efficiency']['uncertainty_type'] = 4
        WTE_Input.Elec_Prod_Eff['Gross_Efficiency']['maximum'] = 0.40
        WTE_Input.Elec_Prod_Eff['Gross_Efficiency']['minimum'] = 0.10
    ...
    if 'GC' in Treatment_processes:
        ...
        GC_Input.Energy['elec_gen_eff_HP']['uncertainty_type'] = 4
        GC_Input.Energy['elec_gen_eff_HP']['minimum'] = 0.10
        GC_Input.Energy['elec_gen_eff_HP']['maximum'] = 0.45
